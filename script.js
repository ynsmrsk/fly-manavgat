...
const messages = {
  tr: {
    ...
    pricing: {
      ...
      p1_description: 'Profesyonel tandem pilot eşliğinde Manavgat semalarında uçuş.',
      p1_feature_1: 'Otelden ücretsiz alınış',
      p1_feature_2: 'Tandem yamaç paraşütü uçuşu',
      p1_feature_3: 'Açık büfe yemek + 1 saatlik katamaran turu',
      p2_kicker: 'Paket 2',
      p2_title: 'Mix Tur + Yamaç Paraşütü',
      p2_description: 'Toros Dağları safarisi ile yamaç paraşütünü bir araya getiren tam günlük macera.',
      p2_feature_1: 'Otellerden ücretsiz alınış',
      p2_feature_2: 'Toros Dağları\'nda jeep safari',
      p2_feature_3: 'Geleneksel Türk köyünde durak ve fotoğraf molası',
      p2_feature_4: 'Yeşil Kanyon\'a varış',
  ...
  en: {
    ...
    pricing: {
      ...
      p1_description: 'A flight over the skies of Manavgat with a professional tandem pilot.',
      p1_feature_1: 'Free hotel pickup',
      p1_feature_2: 'Tandem paragliding flight',
      p1_feature_3: 'Open buffet meal + 1-hour catamaran trip',
      p2_kicker: 'Package 2',
      p2_title: 'Mix Tour + Paragliding',
      p2_description: 'A full-day adventure combining a Taurus Mountains safari with paragliding.',
      p2_feature_1: 'Free pickup from hotels',
      p2_feature_2: 'Jeep safari in the Taurus Mountains',
      p2_feature_3: 'Stop at a traditional Turkish village and photo break',
      p2_feature_4: 'Arrival at the Green Canyon',
  ...
  ru: {
    ...
    pricing: {
      ...
      p1_kicker: 'Пакет 1',
      p1_title: 'Параплан',
      p1_description: 'Полет над Манавгатом с профессиональным тандем-пилотом.',
      p1_feature_1: 'Бесплатный трансфер от отеля',
      p1_feature_2: 'Тандемный полет на параплане',
      p1_feature_3: 'Обед шведский стол + часовая прогулка на катамаране',
      p2_kicker: 'Пакет 2',
      p2_title: 'Mix-тур + параплан',
      p2_description: 'Целодневное приключение, объединяющее сафари по Таврским горам и полет на параплане.',
      p2_feature_1: 'Бесплатный трансфер от отелей',
      p2_feature_2: 'Джип-сафари по Таврским горам',
      p2_feature_3: 'Остановка в традиционной турецкой деревне и фотопауза',
      p2_feature_4: 'Прибытие в Зеленый каньон',
